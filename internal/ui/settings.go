...
func (d *deskSettings) load() {
	...
	moduleNames := fyne.CurrentApp().Preferences().StringWithFallback("modulenames", "Battery|Brightness|Compositor|Sound|Launcher: Calculate|Launcher: Open URLs|Network|SystemTray")
	if moduleNames != "" {
